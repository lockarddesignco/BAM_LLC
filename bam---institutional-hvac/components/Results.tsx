    ...
    <section className="relative w-full py-24 bg-[#F7F9F8] border-b border-[#D7DDDA]">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-[42px] font-semibold text-[#265A4A] mb-3 tracking-tight leading-tight">
            Verified Results in Mission-Critical Facilities
          </h2>
          <p className="text-[#5E7A86] text-lg font-normal opacity-90">
